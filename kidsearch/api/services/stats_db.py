...
class StatsDatabase:
    ...
    def _init_database(self):
        ...
        cursor.execute("""
            CREATE TABLE IF NOT EXISTS search_queries (
                ...
                typesense_results INTEGER,
                cse_results INTEGER,
                wiki_results INTEGER,
                processing_time_ms REAL,
                typesense_time_ms REAL,
                cse_time_ms REAL,
                wiki_time_ms REAL,
        ...
        try:
            ...
            cursor.execute("""
                INSERT INTO search_queries (
                    ...
                    processing_time_ms, typesense_time_ms, cse_time_ms, wiki_time_ms,
    ...
    def get_avg_typesense_time(self) -> float:
        """Get average Typesense query time in ms."""
        try:
            conn = sqlite3.connect(self.db_path)
            cursor = conn.cursor()
